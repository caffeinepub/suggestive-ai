...
export class Backend implements backendInterface {
    ...
    async getKey(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getKey();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeKey(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeKey();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async storeKey(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.storeKey(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
